        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative group/nav">
                    ...
                    <button
                        onClick={prev}
                        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 z-10 p-3 rounded-full bg-white/90 hover:bg-white shadow-xl border border-gray-100 transition-all opacity-0 group-hover/nav:opacity-100 hidden lg:block text-blue-600"
                    >
                        <ChevronLeft className="w-6 h-6" />
                    </button>
                    <button
                        onClick={next}
                        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 z-10 p-3 rounded-full bg-white/90 hover:bg-white shadow-xl border border-gray-100 transition-all opacity-0 group-hover/nav:opacity-100 hidden lg:block text-blue-600"
                    >
            ...
            <div className="absolute top-0 right-0 w-96 h-96 bg-blue-100/30 blur-[100px] rounded-full -z-10 animate-pulse"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-100/30 blur-[100px] rounded-full -z-10 animate-pulse"></div>
        </section>
    );
};
