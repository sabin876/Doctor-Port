    ...
    return (
        <main className="relative pt-20 bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 lg:py-24">
                ...
                >
                    <div className="bg-white rounded-[3.5rem] p-12 md:p-20 shadow-[0_30px_70px_rgba(0,0,0,0.06)] border border-gray-100 text-center relative overflow-hidden group">
