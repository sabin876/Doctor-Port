...
const SportingInjury = () => {
    useEffect(() => {
        ...
        return () => {
            // Optional: clean up script if needed, though usually fine to keep for other embeds
        ...
        <section className="py-20 bg-gray-50/30">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    {/* Video Section - Integrated Instagram Embed */}
                    <motion.div
                    ...
                    >
                        <div className="w-full max-w-[540px] shadow-2xl rounded-xl overflow-hidden bg-white">
                            <blockquote
                            ...
                            >
                                <div style={{ padding: '16px' }}>
                                    <a href="https://www.instagram.com/reel/DTijxQ3krcw/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background: '#FFFFFF', lineHeight: 0, padding: '0 0', textAlign: 'center', textDecoration: 'none', width: '100%' }} target="_blank">
                                    ...
                                    <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                        <a href="https://www.instagram.com/reel/DTijxQ3krcw/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank">A post shared by Dr. Ulhas Sonar (@drulhasortho.1)</a>
                                    </p>
                                </div>
                            </blockquote>
                        </div>
